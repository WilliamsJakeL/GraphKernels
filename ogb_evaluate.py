...
d = pickle.load(open('data/OGB_mollipo_1.train.pickle', 'rb'))
...
print("Loading Test")
d_test = pickle.load(open('data/OGB_mollipo_1.test.pickle', 'rb'))
...
with open('predictions/OGB_mollipo_1.txt', 'w') as file:
