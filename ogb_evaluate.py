...
d = pickle.load(open('data/OGB_mollipo.train.pickle', 'rb'))
...
print("Loading Test")
d_test = pickle.load(open('data/OGB_mollipo.test.pickle', 'rb'))
...
with open('predictions/OGB_mollipo_baseline.txt', 'w') as file:
