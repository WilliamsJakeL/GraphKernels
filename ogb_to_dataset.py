...
pickle.dump(train_d, open('data/OGB_mollipo_1.train.pickle', 'wb'))
pickle.dump(test_d, open('data/OGB_mollipo_1.test.pickle', 'wb'))
pickle.dump(valid_d, open('data/OGB_mollipo_1.valid.pickle', 'wb'))