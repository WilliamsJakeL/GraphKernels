...
for r in [0.0001, 0.1, 100, 10000]:
    print("Lambda =",r)
    K = BhattKernel(t=0.5, num_bins=40, graphs=train_graphs, y=train_y,r_lambda=r,calcWeights=True)
...
for r in [0.0001, 0.1, 100, 10000]:
    print("Lambda =",r)
    K = BhattKernel(t=0.5, num_bins=40, graphs=train_graphs_50, y=train_y_50,r_lambda=r,calcWeights=True)
